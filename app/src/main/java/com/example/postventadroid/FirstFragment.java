...
import com.example.postventadroid.Adapter.ItemAdapter;
import com.example.postventadroid.Model.Item;
import com.example.postventadroid.databinding.FragmentFirstBinding;
...
public class FirstFragment extends Fragment {
    ...
    //forma reoomendada para trabajar con las vistas xml en este caso nuestro rycler view
    // el cual contiene un adaptery debe ser instanciado
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);

//instancia itemAdapter= se ingresa el metodo apartment list el cual contiene el listado de objetos en un array List
        ItemAdapter itemAdapter = new ItemAdapter(apartmentList());
        binding.rvItem.setAdapter(itemAdapter);
        //administrador de Layouts , existen 3 tipos de administradores , linear layout manager
